...
import { Shield, ArrowRight, Eye, EyeOff, GitFork } from "lucide-react";
      ...
      >
        ...
        <div style={{ padding: "28px 28px 32px" }}>
          ...
          <p style={{ fontSize: 13, color: "var(--text-muted)", marginBottom: 24 }}>
            {mode === "signup"
              ? "Connect your stack and see revenue impact in minutes."
              : "Continue to your BugCost dashboard."}
          </p>
          ...
          <button
            ...
            onMouseEnter={e => !loading && (e.currentTarget.style.borderColor = "var(--blue-bright)")}
